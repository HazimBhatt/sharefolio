...
const PaymentSuccessContent = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-[#7332a8]/5 to-background flex items-center justify-center px-4">
      <motion.div
      ...
      >
        ...
        <motion.div
          ...
          className="bg-card rounded-2xl border border-green-200 dark:border-green-800 p-6 mb-8"
        >
          ...
          <div className="space-y-2 text-sm text-muted-foreground">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-foreground">{currentPlan.tokens}</span>
            </div>
            {amount && amount !== '0' && (
              <div className="flex justify-between">
                <span>Amount Paid:</span>
                <span className="font-medium text-foreground flex items-center"><IndianRupee/>{amount}</span>
              </div>
            )}
            {paymentId && (
              <div className="flex justify-between">
                <span>Payment ID:</span>
                <span className="font-medium text-foreground text-xs">{paymentId.slice(-8)}</span>
              </div>
            )}
          </div>
        </motion.div>
